...
public class MyGenerator {
	 ...
	 * 代码文件生成路径（根据自己需要修改）
	 */
	public static String outPutPath = "F:\\学习实践\\back\\fast-admin\\src\\main\\java";
//	public static String outPutPath = "D:\\JobSpace\\back\\fast-admin\\src\\main\\java";
//	public static String outPutPath = "D:\\logs";
	 ...
	 * 表名（根据表名修改）
	 */
	public static String tableName = "tb_order";
